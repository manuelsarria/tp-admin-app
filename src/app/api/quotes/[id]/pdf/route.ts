...
import { QuoteDocument } from '@/components/cotizaciones/QuotePDF'
import fs from 'fs'
...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    // Load images as base64 for PDF embedding
    ...
    const pdfBuffer = await renderToBuffer(
      createElement(QuoteDocument, { quote: quote as any, logoBase64, bannerBase64 }) as ReactElement<any>
    )
