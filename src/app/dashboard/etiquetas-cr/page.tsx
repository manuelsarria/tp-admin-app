    ...
    <Box>
      <Box sx={{ mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1 }}>
          ...
          <Typography variant="h5" sx={{ fontWeight: 700, color: '#0A0A0A' }}>Generador de Etiquetas — Costa Rica</Typography>
        </Box>
          ...
          <Card sx={{ mb: 3, borderRadius: 3, border: '2px solid #002B7F', boxShadow: 'none' }}>
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 700, color: '#0A0A0A' }}>
                  Nueva Etiqueta CR
                </Typography>
              </Box>
        ...
        <Grid item xs={12} lg={7}>
          <Card sx={{ borderRadius: 3, border: '1px solid #E5E7EB', boxShadow: 'none' }}>
            <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
              <Typography variant="subtitle2" sx={{ fontWeight: 700, color: '#0A0A0A', mb: 2 }}>
                Vista Previa
              </Typography>
