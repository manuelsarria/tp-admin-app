    ...
    items: [
      {
        ...
        children: [
          ...
          {
            id: 'seguros',
            label: 'Seguros Cotizados',
            icon: <FolderOpen />,
            path: '/dashboard/cotizaciones/seguros',
            roles: ['ADMIN'],
          },
          {
            id: 'aduanas',
...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const pageTitle = (() => {
    const map: [string, string][] = [
      ...
      ['/dashboard/cotizaciones/seguros', 'Seguros Cotizados'],
      ...
      ['/dashboard/freight/lcl/bookings', 'HBL China'],
      ['/dashboard/freight/lcl/containers', 'MBL China — Contenedores'],
      ['/dashboard/freight/pa/hbl', 'HBL Panamá'],
      ['/dashboard/freight/pa/mbl', 'MBL Panamá — Contenedores'],
