    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1 }}>
          ...
          <Typography variant="h5" sx={{ fontWeight: 700, color: '#0A0A0A' }}>{checklist.title}</Typography>
      ...
      <Card sx={{ mb: 3, borderRadius: 3, border: '1px solid #E5E7EB', boxShadow: 'none' }}>
        <CardContent sx={{ p: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1.5 }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 700, color: '#0A0A0A' }}>Progreso General</Typography>
                  ...
                  <Box sx={{ flex: 1, minWidth: 0 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Typography variant="body1" sx={{
                        fontWeight: 600, color: '#0A0A0A', fontSize: '0.9rem',
